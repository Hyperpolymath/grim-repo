...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "*Modular audit-grade tooling for narratable, scaffolded, and legible repositories*")
...
(define development-practices
  '((code-style
     (languages . ("JavaScript" "Just" "Nix" "ReScript" "Scheme"))
     (formatter . "prettier")
     (linter . "eslint")
     (line-length . 100)
     (indent . "spaces")
